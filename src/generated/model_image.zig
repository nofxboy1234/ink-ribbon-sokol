...
pub extern fn model_image_decode_rgba(encoded: [*c]const u8, encoded_size: usize, width: [*c]c_int, height: [*c]c_int) [*c]u8;
pub extern fn model_image_free(pixels: [*c]u8) void;
